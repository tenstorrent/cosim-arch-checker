...
/****************************** OBJECT TYPES ******************************/
#define vpiAlways             1   /* used in always block       */
...
#define vpiLogImplOp         45   /* binary logical implication */
#define vpiLogEquOp          46   /* binary logical euqivalence */
...
#define vpiCaseInside         4   /* case inside */ 
...
#define vpiValid               64  /* reentrant task/func frame or
                                      automatic variable is valid */
...
#define vpiIsProtected 74 /* TRUE for a protected design information */
...
#ifdef ABVAL_AS_PLI_INT32_VCS
    PLI_INT32 aval, bval;          /* bit encoding:
...
typedef struct t_vpi_value
{
    ...
    union
    {
        ...
        /* Synopsys Internally used by StimGen */
    } value;
} s_vpi_value, *p_vpi_value;

typedef struct t_vpi_arrayvalue
{
    PLI_UINT32 format;   /* vpi[Int, Real, Time, ShortInt, LongInt,
                            ShortReal, RawTwoState, RawFourState]Val */
...
typedef struct t_vpi_systf_data
{
    ...
    PLI_INT32 sysfunctype;                /* vpiSysTask, vpi[Int,Real,Time,
                                             Sized, SizedSigned]Func */
...
#define cbAtEndOfSimTime         31 /* As per LRM*/

/***************************** Configure Types *****************************/
#define vpiDisplayErrors          1
#define vpiDisplayWarnings        2
#define vpiDisplayClockOptError   3
#define vpiDeepSearch             4
#define vpiUseExprEvalHooks       5 /* Synopsys VCS internal usage only */
#define vpiIgnoreErrors           6 /* Synopsys VCS internal usage only */
#define vpiFindLowPowerDrivers    8 /* Synopsys VCS internal usage only */
#define vpiIterateOverGeneratedProcesses  9 /* Synopsys VCS internal usage only */
#define vpiShowPortMismatchDriver 10 /* Synopsys VCS internal usage only */
/* More configure types for Synopsys VCS internal usage are
 * defined in vcs_vpi_user.h: 7, 11-... */
...
/* utility routines */
XXTERN PLI_INT32  vpi_compare_objects_1364v1995 PROTO_PARAMS((vpiHandle object1,
        vpiHandle object2));
XXTERN PLI_INT32  vpi_control_1364v1995         PROTO_PARAMS((PLI_INT32 operation,
        ...));
/* for processing properties */
XXTERN PLI_INT32  vpi_get_1364v1995             PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
XXTERN PLI_BYTE8 *vpi_get_str_1364v1995         PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
/* value processing */
XXTERN void       vpi_get_value_1364v1995       PROTO_PARAMS((vpiHandle expr,
        p_vpi_value value_p));
XXTERN vpiHandle  vpi_handle_1364v1995          PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_handle_by_index_1364v1995 PROTO_PARAMS((vpiHandle object,
        PLI_INT32 indx));
XXTERN vpiHandle  vpi_handle_by_multi_index_1364v1995 PROTO_PARAMS((vpiHandle obj,
        PLI_INT32 num_index,
        PLI_INT32 *index_array));
XXTERN vpiHandle  vpi_handle_by_name_1364v1995  PROTO_PARAMS((PLI_BYTE8 *name,
        vpiHandle scope));
XXTERN vpiHandle  vpi_handle_multi_1364v1995    PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle1,
        vpiHandle refHandle2,
        ... ));
XXTERN vpiHandle  vpi_iterate_1364v1995         PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_put_value_1364v1995       PROTO_PARAMS((vpiHandle object,
        p_vpi_value value_p,
        p_vpi_time time_p,
        PLI_INT32 flags));
XXTERN vpiHandle  vpi_register_cb_1364v1995     PROTO_PARAMS((p_cb_data cb_data_p));
XXTERN vpiHandle  vpi_scan_1364v1995            PROTO_PARAMS((vpiHandle iterator));



/* utility routines */
XXTERN PLI_INT32  vpi_compare_objects_1364v2001 PROTO_PARAMS((vpiHandle object1,
        vpiHandle object2));
XXTERN PLI_INT32  vpi_control_1364v2001         PROTO_PARAMS((PLI_INT32 operation,
        ...));
/* for processing properties */
XXTERN PLI_INT32  vpi_get_1364v2001             PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
XXTERN PLI_BYTE8 *vpi_get_str_1364v2001         PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
/* value processing */
XXTERN void       vpi_get_value_1364v2001       PROTO_PARAMS((vpiHandle expr,
        p_vpi_value value_p));
XXTERN vpiHandle  vpi_handle_1364v2001          PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_handle_by_index_1364v2001 PROTO_PARAMS((vpiHandle object,
        PLI_INT32 indx));
XXTERN vpiHandle  vpi_handle_by_multi_index_1364v2001 PROTO_PARAMS((vpiHandle obj,
        PLI_INT32 num_index,
        PLI_INT32 *index_array));
XXTERN vpiHandle  vpi_handle_by_name_1364v2001  PROTO_PARAMS((PLI_BYTE8 *name,
        vpiHandle scope));
XXTERN vpiHandle  vpi_handle_multi_1364v2001    PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle1,
        vpiHandle refHandle2,
        ... ));
XXTERN vpiHandle  vpi_iterate_1364v2001         PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_put_value_1364v2001       PROTO_PARAMS((vpiHandle object,
        p_vpi_value value_p,
        p_vpi_time time_p,
        PLI_INT32 flags));
XXTERN vpiHandle  vpi_register_cb_1364v2001     PROTO_PARAMS((p_cb_data cb_data_p));
XXTERN vpiHandle  vpi_scan_1364v2001            PROTO_PARAMS((vpiHandle iterator));

/* utility routines */
XXTERN PLI_INT32  vpi_compare_objects_1364v2005 PROTO_PARAMS((vpiHandle object1,
        vpiHandle object2));
XXTERN PLI_INT32  vpi_control_1364v2005         PROTO_PARAMS((PLI_INT32 operation,                                                    ...));
/* for processing properties */
XXTERN PLI_INT32  vpi_get_1364v2005             PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
XXTERN PLI_BYTE8 *vpi_get_str_1364v2005         PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
/* value processing */
XXTERN void       vpi_get_value_1364v2005       PROTO_PARAMS((vpiHandle expr,
        p_vpi_value value_p));
XXTERN vpiHandle  vpi_handle_1364v2005          PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_handle_by_index_1364v2005 PROTO_PARAMS((vpiHandle object,
        PLI_INT32 indx));
XXTERN vpiHandle  vpi_handle_by_multi_index_1364v2005 PROTO_PARAMS((vpiHandle obj,
        PLI_INT32 num_index,
        PLI_INT32 *index_array));
XXTERN vpiHandle  vpi_handle_by_name_1364v2005  PROTO_PARAMS((PLI_BYTE8 *name,
        vpiHandle scope));
XXTERN vpiHandle  vpi_handle_multi_1364v2005    PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle1,
        vpiHandle refHandle2,
        ... ));
XXTERN vpiHandle  vpi_iterate_1364v2005         PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_put_value_1364v2005       PROTO_PARAMS((vpiHandle object,
        p_vpi_value value_p,
        p_vpi_time time_p,
        PLI_INT32 flags));
XXTERN vpiHandle  vpi_register_cb_1364v2005     PROTO_PARAMS((p_cb_data cb_data_p));
XXTERN vpiHandle  vpi_scan_1364v2005            PROTO_PARAMS((vpiHandle iterator));

/* utility routines */
XXTERN PLI_INT32  vpi_compare_objects_1800v2005 PROTO_PARAMS((vpiHandle object1,
        vpiHandle object2));
XXTERN PLI_INT32  vpi_control_1800v2005         PROTO_PARAMS((PLI_INT32 operation,
        ...));
/* for processing properties */
XXTERN PLI_INT32  vpi_get_1800v2005             PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
XXTERN PLI_BYTE8 *vpi_get_str_1800v2005         PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
/* value processing */
XXTERN void       vpi_get_value_1800v2005       PROTO_PARAMS((vpiHandle expr,
        p_vpi_value value_p));
XXTERN vpiHandle  vpi_handle_1800v2005          PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_handle_by_index_1800v2005 PROTO_PARAMS((vpiHandle object,
        PLI_INT32 indx));
XXTERN vpiHandle  vpi_handle_by_multi_index_1800v2005 PROTO_PARAMS((vpiHandle obj,
        PLI_INT32 num_index,
        PLI_INT32 *index_array));
XXTERN vpiHandle  vpi_handle_by_name_1800v2005  PROTO_PARAMS((PLI_BYTE8 *name,
        vpiHandle scope));
XXTERN vpiHandle  vpi_handle_multi_1800v2005    PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle1,
        vpiHandle refHandle2,
        ... ));
XXTERN vpiHandle  vpi_iterate_1800v2005         PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_put_value_1800v2005       PROTO_PARAMS((vpiHandle object,
        p_vpi_value value_p,
        p_vpi_time time_p,
        PLI_INT32 flags));
XXTERN vpiHandle  vpi_register_cb_1800v2005     PROTO_PARAMS((p_cb_data cb_data_p));
XXTERN vpiHandle  vpi_scan_1800v2005            PROTO_PARAMS((vpiHandle iterator));



/* utility routines */
XXTERN PLI_INT32  vpi_compare_objects_1800v2009 PROTO_PARAMS((vpiHandle object1,
        vpiHandle object2));
XXTERN PLI_INT32  vpi_control_1800v2009         PROTO_PARAMS((PLI_INT32 operation,
        ...));
/* for processing properties */
XXTERN PLI_INT32  vpi_get_1800v2009             PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
XXTERN PLI_BYTE8 *vpi_get_str_1800v2009         PROTO_PARAMS((PLI_INT32 property,
        vpiHandle object));
/* value processing */
XXTERN void       vpi_get_value_1800v2009       PROTO_PARAMS((vpiHandle expr,
        p_vpi_value value_p));
XXTERN vpiHandle  vpi_handle_1800v2009          PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_handle_by_index_1800v2009 PROTO_PARAMS((vpiHandle object,
        PLI_INT32 indx));
XXTERN vpiHandle  vpi_handle_by_multi_index_1800v2009 PROTO_PARAMS((vpiHandle obj,
        PLI_INT32 num_index,
        PLI_INT32 *index_array));
XXTERN vpiHandle  vpi_handle_by_name_1800v2009  PROTO_PARAMS((PLI_BYTE8 *name,
        vpiHandle scope));
XXTERN vpiHandle  vpi_handle_multi_1800v2009    PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle1,
        vpiHandle refHandle2,
        ... ));
XXTERN vpiHandle  vpi_iterate_1800v2009         PROTO_PARAMS((PLI_INT32 type,
        vpiHandle refHandle));
XXTERN vpiHandle  vpi_put_value_1800v2009       PROTO_PARAMS((vpiHandle object,
        p_vpi_value value_p,
        p_vpi_time time_p,
        PLI_INT32 flags));
XXTERN vpiHandle  vpi_register_cb_1800v2009     PROTO_PARAMS((p_cb_data cb_data_p));
XXTERN vpiHandle  vpi_scan_1800v2009            PROTO_PARAMS((vpiHandle iterator));
